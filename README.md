This project focuses on analyzing coffee shop sales data using Excel to generate valuable business insights. The dataset includes information on transactions, products, store locations, and sales details.
